...
<html lang="pt-br">
    <head>
        ...
        <meta name="description" content="Verificar E-mail para redefinir senha do usuário">
        <link rel="canonical" href="{{ route('verificacao.email') }}">
    ...
    <body>
        ...
        <main>
            <div class="container">
                <h2>Verificar E-mail para Redefinição de Senha</h2>
                <form action="{{ route('verificar.email.redefinicao') }}" method="POST">
                    @csrf
                    ...
                    @else
                        <div class="container-links-form">
                            <a href="{{ route('login.cadastro') }}" class="link-login">Fazer login!</a>
                        </div>
                    @endif
                </form>
            </div>
