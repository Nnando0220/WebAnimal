...
<html lang="pt-br">
    <head>
        ...
        <meta name="description" content="Redefinir E-mail do usuário">
        <link rel="canonical" href="{{ route('pagina.redefinir.email', ['token' => $token]) }}">
    ...
    <body>
        ...
        <main>
            <div class="container">
                ...
                <form action="{{ route('redefinir.email') }}" method="POST">
                    @csrf
